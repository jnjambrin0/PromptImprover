...
enum AppTestSupport {
    ...
    static func templateRootURL() -> URL {
        repositoryRootURL().appendingPathComponent("PromptImprover/Resources/templates", isDirectory: true)
    }

    static func makeTemporaryDirectory(prefix: String) throws -> URL {
        let directory = URL(fileURLWithPath: NSTemporaryDirectory(), isDirectory: true)
            .appendingPathComponent("PromptImproverAppTests", isDirectory: true)
