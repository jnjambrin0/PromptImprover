...
enum GuidesDefaults {
    ...
    private static let builtInTemplateByGuideID: [String: String] = [
        claudeGuideID: "claude-4-6-prompt-guide.md",
        gptGuideID: "gpt-5-2-prompt-guide.md",
        geminiGuideID: "gemini-3-0-prompt-guide.md",
    ]
    ...
    static let builtInGuides: [GuideDoc] = [
        GuideDoc(
            ...
            storagePath: "guides/builtin/claude-4-6-prompt-guide.md",
            isBuiltIn: true,
        ...
        GuideDoc(
            ...
            storagePath: "guides/builtin/gpt-5-2-prompt-guide.md",
            isBuiltIn: true,
            updatedAt: builtInUpdatedAt
        ),
        GuideDoc(
            ...
            storagePath: "guides/builtin/gemini-3-0-prompt-guide.md",
            isBuiltIn: true,
            updatedAt: builtInUpdatedAt
        )
    ]
